...
RSpec.describe PlaylistsController, type: :controller do
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assings a newly created playlist as @playlist" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "assings the requested playlist as @playlist" do
        playlist = create(:playlist)
        put(:update, {:id => playlist.to_param, :playlist => attributes_for(:playlist, name: "New name")})
    ...
    context "with invalid params" do
      it "assings the playlsit as @playlsit" do
        playlist = create(:playlist)
      ...
      it "re-renders the requested playlist" do
        playlist = create(:playlist)
        put(:update, {:id => playlist.to_param, :playlist => attributes_for(:playlist, name: nil)})
